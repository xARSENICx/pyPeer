...
class Ui_StartWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow) -> None:
        MainWindow.setWindowTitle(QCoreApplication.translate("StartWindow", "Welcome To pyPeer", None))
        self.label.setText(QCoreApplication.translate("StartWindow", "pyPeer", None))
